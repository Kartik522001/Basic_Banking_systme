...
<div class="form">
  <div class="form__box">
    <div class="form__left">
      <div class="form__padding"><img class="form__image" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSqoqh7PTzdjkbz8HIDWJPBQB8VpFPg7SxfXg&usqp=CAU" alt=""/></div>
    </div>
      ...
      <div class="form__padding-right">
        <form method="post">
          <h1 class="form__title">Create a user</h1>
            ...
            <label>
                <input class="" type="number" placeholder="Balance" name="balance" required/>
            </label>
